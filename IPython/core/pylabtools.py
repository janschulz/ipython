...
def configure_inline_support(shell, backend):
    ...
    # only enable the formats once -> don't change the enabled formats (which the usere may
    # have chnaged) when getting another "%matplotlib inline" call.
    ...
    if new_backend_name != cur_backend:
        ...
        setattr(configure_inline_support, "current_backend", new_backend_name)
